...
class CommonFunction():
    ...
    def save(self,path,command,e_type='one',data=None,show_s_succes=False):
...
class Start_up(Tk):
    ...
    def __init__(self):
        ...
        self.background_img=self.background_img.resize((width-2,height-2))
...
class NewUser():
    ...
    def __init__(self,background_img):
        ...
        try:
            ...
            pass
        background_label=Label(self,image=background_img)
        remove_list.append(background_label)
...
class Main():
    ...
    def t_time(self):
        ...
        timet = "sadasdsadsadsafafasfasfsaf"
...
def main():
    ...
    if db_file_check==False:
        common_func=CommonFunction()
        common_func.save(path=db_path,data=None,e_type='one',command="""CREATE TABLE IF NOT EXISTS time_data(
                name TEXT
                hour INTEGER
                mins INTEGER
                secs INTEGER)""")
        create_data=NewUser(start_up.background_img)
    else:
        Main("faraaz")
